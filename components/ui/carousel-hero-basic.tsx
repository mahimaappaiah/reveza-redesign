...
export function CarouselHeroBasic() {
  ...
  return (
    <ImageCarouselHero
      ...
      subtitle="Reveza Technologies · Enterprise Transformation Partner"
      description="We modernize the core ERP and operational engines that run your business—weaving in the applied AI, real-time data, and customer engagement layers."
